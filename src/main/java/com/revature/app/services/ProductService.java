...
public class ProductService {
    ...
    public void updateOnHand(String productId, String user_id, String quantity) {
        this.orderDAO.updateOnHand(productId, user_id, quantity);
    }
    ...
    public Optional<Order> retrieveOrder(String user_id) {
